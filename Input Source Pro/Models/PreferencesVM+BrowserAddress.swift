...
enum BrowserThatCanWatchBrowserAddressFocus: CaseIterable {
    ...
    case Safari, SafariTechnologyPreview, Chrome, Chromium, Brave, BraveBeta, BraveNightly, Edge, Vivaldi, Arc, Opera, Firefox, FirefoxNightly, FirefoxDeveloperEdition, Zen, Dia, ChatGPTAtlas
    ...
    func isFocusOnBrowserAddress(focusedElement: UIElement?) -> Bool {
        ...
        case .Chromium, .Chrome, .Brave, .BraveBeta, .BraveNightly, .Edge, .Dia, .ChatGPTAtlas:
